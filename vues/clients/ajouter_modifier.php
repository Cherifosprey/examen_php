...
<main class="content">
    ...
    <form action="" method="POST">
        ...
        <button type="submit" class="btn btn-primary"><?= $isEdit ? 'Mettre à jour' : 'Ajouter' ?> le client</button>
        <a href="<?= BASE_URL ?>index.php?action=clients" class="btn btn-secondary">Annuler</a>
    </form>
</main>
